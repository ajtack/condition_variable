 ...
 *
 * This file, in particular, demonstrates that the same code works in a C++ environment
 * entirely unchanged.
 *
...
void* signal_condition(void* _condition)
{
  cond_event_t* condition = reinterpret_cast<cond_event_t*>(_condition);
